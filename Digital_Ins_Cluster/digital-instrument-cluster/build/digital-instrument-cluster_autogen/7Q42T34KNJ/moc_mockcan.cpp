...
void MockCAN::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (MockCAN::*)(float )>(_a, &MockCAN::speedChanged, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (MockCAN::*)(float )>(_a, &MockCAN::rpmChanged, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (MockCAN::*)(float )>(_a, &MockCAN::fuelLevelChanged, 2))
            return;
    }
}
