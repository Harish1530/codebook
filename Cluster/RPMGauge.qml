...
Item {
    ...
    // ------------------- CAN-Bound Property -------------------
    property real rpm: cluster.rpm        // ← live from CAN (NOT x1000; your labels already show x1000)
    ...
    readonly property real needleLength: innerRadius - 2
    ...
    // Start smoothing on CAN updates
    onRpmChanged: if (!animTimer.running) animTimer.start()
    ...
    Canvas {
        ...
        onPaint: {
            ...
            ctx.strokeStyle = "#fff"
            ctx.lineWidth = 2
            ctx.font = "18px DejaVu Sans, Ubuntu, Sans-Serif"
