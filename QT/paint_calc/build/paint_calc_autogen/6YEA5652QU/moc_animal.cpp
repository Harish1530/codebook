...
Q_CONSTINIT static const qt_meta_stringdata_Animal_t qt_meta_stringdata_Animal = {
    {
        ...
        QT_MOC_LITERAL(19, 0),  // ""
        QT_MOC_LITERAL(20, 7),  // "newName"
        QT_MOC_LITERAL(28, 10),  // "ageChanged"
        QT_MOC_LITERAL(39, 6)   // "newAge"
    },
    "Animal",
    "nameChanged",
    "",
...
void Animal::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Animal::*)(const QString & );
            if (_t _q_method = &Animal::nameChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Animal::*)(int );
            if (_t _q_method = &Animal::ageChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Animal::nameChanged(const QString & _t1)
{
...
// SIGNAL 1
void Animal::ageChanged(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
